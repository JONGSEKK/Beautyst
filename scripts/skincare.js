const tutorial = document.getElementById("article-skincare");
const PopularArticle = document.getElementById("popular-article");

function displayArticleFashion() {
    fetch('http://localhost:5133/api/Article/skincare')
        .then(res => {
            return res.json();
        })
        .then(data => {
